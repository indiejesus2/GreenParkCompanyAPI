...
Profile.create(employee_id: 2, fname: "Bill", lname: "Gates", city: "Howell", state: "NJ", zipcode: "07731", jobtype: ["Part Time", "Contract"], schedule: ["Weekdays"], seasonstart: "Mar", seasonend: "Aug", minpay: 17, maxpay: 21, industry: "Plumbing")
Profile.create(employee_id: 3, fname: "Vincent", lname: "Van Gogh", city: "Trenton", state: "NJ", jobtype: ["Full Time", "Part Time", "Temporary"], schedule: ["Weekdays"], seasonstart: "Mar", seasonend: "Aug", minpay: 17, maxpay: 21, industry: "Painting")
