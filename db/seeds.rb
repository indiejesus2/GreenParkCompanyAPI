...
Profile.create(employee_id: 1, fname: "Steve", lname: "Jobs", city: "Jackson", state: "NJ", zipcode: "08527", license: true, jobtype: ["FT", "PT", "Temporary"], schedule: ["MF"], shifts: ["AM"], seasonstart: "MAR", seasonend: "AUG", minpay: 17, maxpay: 21, industry: "Electric")
...
Profile.create(employee_id: 4, fname: "Steve", lname: "Martin", city: "Toms River", state: "NJ", zipcode: "08753", license: false, jobtype: ["FT", "PT", "Temporary"], schedule: ["MF, Weekends"], shifts: ["PM"], seasonstart: "JUL", seasonend: "DEC", minpay: 19.00, maxpay: 25, industry: "Electric")
...
Job.create(title: "Electrician", status: true, city: "Howell", state: "NJ", zipcode: "08753", license: true, jobtype: ["PT"], schedule: ["MF, Weekends"], shifts: ["PM"], seasonstart: "APR", seasonend: "SEPT", minpay: 15.00, maxpay: 19.50, industry: "Electric", description: "Painting houses, rooms and everything in between.", employer_id: 1)
