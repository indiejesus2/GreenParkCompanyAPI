...
Profile.create(employee_id: 3, fname: "Vincent", lname: "Van Gogh", city: "Trumansburg", state: "NY", jobtype: ["FT", "PT", "Temporary"], schedule: ["MF"], skills: ["painting"])
Profile.create(employee_id: 4, fname: "Steve", lname: "Martin", city: "Toms River", state: "NJ", jobtype: ["FT", "PT", "Temporary"], schedule: ["MF"], skills: ["electric"])
