...
Job.create(title: "Painter", status: true, city: "Jackson", state: "NJ", zipcode: "08527", jobtype: ["FT"], schedule: ["MF", "Weekends"], industry: "Painting", description: "Painting houses, rooms and everything in between.", employer_id: 1)
Job.create(title: "Electrician", status: true, city: "Howell", state: "NJ", zipcode: "08753", industry: "Electric", description: "Painting houses, rooms and everything in between.", employer_id: 1)
