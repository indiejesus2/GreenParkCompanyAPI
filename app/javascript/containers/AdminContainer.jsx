        ...
        return (
                <div className="admin">
                    ...
                    <Switch>
                        ...
                        <Route path='/admin/employers' render={(routerProps) => <EmployersAdmin {...routerProps} loggedIn={this.props.loggedIn} loading={this.props.loading} employees={this.props.employees} employers={this.props.employers} jobs={this.props.jobs} updateProfile={this.props.updateProfile} deleteEmployer={this.props.deleteEmployer} />}></Route>
                        <Route path='/admin/employees' render={(routerProps) => <EmployeesAdmin {...routerProps} loggedIn={this.props.loggedIn} loading={this.props.loading} employees={this.props.employees} employers={this.props.employers} jobs={this.props.jobs} updateProfile={this.props.updateProfile} deleteEmployee={this.props.deleteEmployee} />}></Route>
                        <Route path='/admin/jobs' render={(routerProps) => <JobsAdmin {...routerProps} loggedIn={this.props.loggedIn} loading={this.props.loading} employees={this.props.employees} employers={this.props.employers} jobs={this.props.jobs} updateProfile={this.props.updateProfile} deleteJob={this.props.deleteJob} />}></Route>
                        <Route path='/admin' render={(routerProps) => <Dashboard {...routerProps} loggedIn={this.props.loggedIn} loading={this.props.loading} employees={this.props.employees} employers={this.props.employers} jobs={this.props.jobs} deleteJob={this.props.deleteJob} deleteEmployee={this.props.deleteEmployee} deleteEmployer={this.props.deleteEmployer}/>}></Route>
                    </Switch>
                </div>
            )
    }
