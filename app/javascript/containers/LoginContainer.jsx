        ...
        if (this.props.employeeErrors == "Incorrect Username/Password" || this.props.contractorErrors == "Incorrect Username/Password") {
            ...
            return(
                ...
                <Switch>
                    ...
                    <Route path='/home/signOut' render={(routerProps) => <SignOut {...routerProps} clearEmployeeErrors={this.props.clearEmployeeErrors} clearContractorErrors={this.props.clearContractorErrors} signOut={this.props.signOut}/>}></Route>
