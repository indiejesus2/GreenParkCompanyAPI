...
class JobsContainer extends Component {
    ...
    render() {
            return (
                <div className="jobs">
                    <Switch>
                        <Route path='/contractors/:id/jobs/:job_id/editjob' render={(routerProps) => <EditJob {...routerProps} jobs={this.props.jobs} contractor={this.props.contractor} editJob={this.props.editJob} loggedIn={this.props.loggedIn}/>}></Route>
                        <Route path='/contractors/:id/jobs/:job_id' render={(routerProps) => <Job {...routerProps} contractor={this.props.contractor} jobs={this.props.jobs} applicants={this.props.applicants} candidates={this.props.candidates} profiles={this.props.profiles} fetchJob={this.props.fetchJob} editApplicant={this.props.editApplicant} loggedIn={this.props.loggedIn}/>}></Route>
