            ...
            return (
                <div className="jobs">
                    <Switch>
                        ...
                        <Route path='/employers' render={(routerProps) => <Jobs {...routerProps} loading={this.props.loading} signIn={this.props.signIn} loggedIn={this.props.loggedIn} contractor={this.props.contractor} profile={this.props.profile} jobs={this.props.jobs} deleteJob={this.props.deleteJob} editApplicant={this.props.editApplicant}/>}></Route>
                    </Switch>
                </div>
            )
    }
