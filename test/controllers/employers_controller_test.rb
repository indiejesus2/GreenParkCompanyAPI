...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { email: @employer.email, name: @employer.name, password: 'secret', password_confirmation: 'secret', zipcode: @employer.zipcode } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { email: @employer.email, name: @employer.name, password: 'secret', password_confirmation: 'secret', zipcode: @employer.zipcode } }
